...
[flake-parts-builder](https://github.com/tsandrini/flake-parts-builder) lets you add or remove templated flake-parts modules (called *parts*) at any time — not just at project initialisation.
